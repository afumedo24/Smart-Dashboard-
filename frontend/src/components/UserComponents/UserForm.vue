...
<template>
  <div
    ...
    <!-- Username Input -->
    <input type="text" v-model="user.username" :disabled="!isEditing" placeholder="Username"
      class="w-full p-4 mb-4 md:text-lg rounded-xl focus:border-secondary focus:ring-1 focus:ring-secondary focus:outline-none" />

    <!-- Email Input -->
    <input type="email" v-model="user.email" :disabled="!isEditing" placeholder="Email"
      class="w-full p-4 mb-4 md:text-lg rounded-xl focus:border-secondary focus:ring-1 focus:ring-secondary focus:outline-none" />

    <!-- Password Input -->
    <input type="password" v-model="user.password" disabled placeholder="Password"
      class="w-full p-4 mb-4 md:text-lg rounded-xl focus:border-secondary focus:ring-1 focus:ring-secondary focus:outline-none" />
    ...
    <!-- Delete User link -->
    <p v-if="isEditing" @click="userStore.deleteUser()"
